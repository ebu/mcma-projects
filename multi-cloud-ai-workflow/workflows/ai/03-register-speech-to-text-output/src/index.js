...
const loggerProvider = new AwsCloudWatchLoggerProvider("ai-workflow-03-register-speech-to-text-output", process.env.LogGroupName);
...
//    logger.info(transcript);
        ...
        try {
            ...
            throw new Exception("Unable to create stt file: error: " + error.message, error);
        }
...
//    logger.info(originalTranscriptionToSrt);
        ...
        try {
            ...
            throw new Exception("Unable to create srt file: error: " + error.message, error);
        }
...
/////////////////////////////////////////////////////////////////////////////////
        ...
        try {
            ...
            throw new Exception("Unable to access file in bucket '" + WebsiteBucket + "' with key '" + "assets/stt/stt_output_clean" + ".txt" + "' due to error: " + error.message);
        }
...
//    logger.info(cleanTranscriptionToSrt);
        ...
        try {
            ...
            throw new Exception("Unable to create clean srt file: error: " + error.message, error);
        }
        ...
        try {
            ...
            throw new Exception("Unable to create clean srt file in repo: error: " + error.message, error);
        }
...
////////////////////////////VTT CLEAN/CORRECTED//////////////////////////////
        ...
        if (!bmEssence_vtt_clean.id) {
            throw new Exception("Failed to register BMEssence for VTT.");
        }
...
//    bmContent.awsAiMetadata.cleanTranscription.original = JSON.stringify(transcripts_clean, null, 2);
        ...
        throw new Exception("Failed to register speech to text output", error);
    } finally {
