...
const loggerProvider = new AwsCloudWatchLoggerProvider("ai-workflow-201-detect-celebrities-azure", process.env.LogGroupName);
...
export async function handler(event: InputEvent, context: Context) {
    ...
    try {
        ...
        throw new McmaException("Failed to detect celebrities on Azure", error);
    } finally {
