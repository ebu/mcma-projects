...
async function extractAudio(providers, jobAssignmentHelper) {
    ...
    logger.info("initialisation Google credentials");
    const jobInput = jobAssignmentHelper.getJobInput();
    const googleProjectId = jobAssignmentHelper.getRequest().getRequiredContextVariable("googleProjectId");
    const googleBucketName = jobAssignmentHelper.getRequest().getRequiredContextVariable("googleBucketName");
    const googleClientEmail = jobAssignmentHelper.getRequest().getRequiredContextVariable("googleClientEmail");
//    const googlePrivateKey = workerJobHelper.getRequest().getRequiredContextVariable("googlePrivateKey");

    logger.info('googleProjectId', googleProjectId);
    logger.info('googleBucketName', googleBucketName);
    logger.info('googleClientEmail', googleClientEmail);
    logger.info('googlePrivateKey', googlePrivateKey);
    ...
    if (inputFile.awsS3Bucket && inputFile.awsS3Key) {
        ...
        logger.info("#####################");
        logger.info("GOOGLE BUCKET - SETUP");
        logger.info("#####################");
        ...
        logger.info("###########################");
        logger.info("GOOGLE BUCKET - SETUP - END");
        logger.info("###########################");
    ...
    logger.info("##################");
    logger.info("Speech to Text END");
    logger.info("##################");
