...
const main = async () => {
    ...
    try {
        ...
        let name = "FFmpeg Transform Service";
        let url = params.transform_service_url;
        let authType = params.transform_service_auth_type;
        let authContext = params.transform_service_auth_context;
