...
const main = async () => {
    ...
    try {
        ...
        let name = "Azure AI Service";
        let url = params.azure_ai_service_url;
        let authType = params.azure_ai_service_auth_type;
        let authContext = params.azure_ai_service_auth_context;
