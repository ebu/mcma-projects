...
export async function validateSpeechToTextAzure(providers: ProviderCollection, jobAssignmentHelper: ProcessJobAssignmentHelper<AIJob>) {
    ...
    const clientCall = promisifyRpcClientCall(client);
