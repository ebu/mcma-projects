...
const main = async () => {
    ...
    try {
        ...
        let name = "Media Repository";
        let url = params.media_repository_url;
        let authType = params.media_repository_auth_type;
        let authContext = params.media_repository_auth_context;
        ...
        let service = new MCMA_CORE.Service({
            name,
            resources: [
                new MCMA_CORE.ResourceEndpoint({ resourceType: "BMContent", httpEndpoint: url + "/bm-contents" }),
                new MCMA_CORE.ResourceEndpoint({ resourceType: "BMEssence", httpEndpoint: url + "/bm-essences" })
            ],
            authType,
            authContext
        });
